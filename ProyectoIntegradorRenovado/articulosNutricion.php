...
<html>
  <head>
    ...
    <title>Artículos Nutrición</title>
  </head>
  <body>
    <header>
      <div class="container">
...
<h3 class="tituloNut"><span class="glyphicon glyphicon-apple"></span>Relación entre la comida y las emociones</h3>
            ...
            <a href="./articuloBelleza3.php" style="color:#ff9980">leer más</a></p>
          </div>
...
<h3 class="tituloNut"><span class="glyphicon glyphicon-apple"></span>La importancia del desayuno</h3>
            ...
            <a href="./articuloBelleza2.php" style="color:#ff9980">leer más</a></p>
          </div>
          <div class="fotoArticulosBelleza col-sm-2">
...
<h3 class="tituloNut"><span class="glyphicon glyphicon-apple"></span>Introdución a la alimentación</h3>
            ...
            <a href="./articuloNutricion1.php" style="color:#ff9980">leer más</a></p>
          </div>
          <div class="fotoArticulosBelleza col-sm-2">
            <img src="images/fotoNut.jpg" alt="" width="150px" height="150px">
            <p><span class="glyphicon glyphicon-hand-right" style="color:#ff9980"></span><a href="articulosBelleza.php" style="color:#ff9980" class="link"> Articulos Belleza</a></p>
          </div>
        </div>
      </div>
    </main>
